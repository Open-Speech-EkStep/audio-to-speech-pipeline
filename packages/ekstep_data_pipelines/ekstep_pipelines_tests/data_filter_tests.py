...
class DataMarkerTests(unittest.TestCase):
    ...
    def test__should_filter_by_speaker_duration(self):
        ...
        data_filter = DataFilter()
        filtered = list(data_filter.by_per_speaker_duration(utterances, {'lte_per_speaker_duration': 1, 'gte_per_speaker_duration': 0, 'with_threshold': 2/60}))
        expected_utterances = [
            (1, 'file_10.wav', 40, '1', 13),
            (1, 'file_11.wav', 10, '2', 13),
            (2, 'file_2.wav', 40, '5', 11),
    ...
    def test__should_apply_filters_only_source_and_utterance_duration_and_then_by_snr(self):
        utterances = [
            (1, 'file_10.wav', 4, '1', 13),
            (1, 'file_11.wav', 1, '2', 13),
            (1, 'file_12.wav', 2, '3', 13),
