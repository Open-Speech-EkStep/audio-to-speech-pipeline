...
class FileClusterMappingTests(unittest.TestCase):
    ...
    def test_should_create_speaker_to_filename_map(self):
        ...
        expected = {'mkb_sp_0':
                             ['13_Hashiye_Ka_Siddhant_aur_Sahitya.wav',
                              '14_Hashiye_Ka_Siddhant_aur_Sahitya.wav',
                              '12_Hashiye_Ka_Siddhant_aur_Sahitya.wav'],
                     'mkb_sp_1':
                         ['149_Hindi_Bhasha_ke_Vikas_ki_Purvpithika.wav',
                          '150_Hindi_Bhasha_ke_Vikas_ki_Purvpithika.wav',
                          '153_Hindi_Bhasha_ke_Vikas_ki_Purvpithika.wav'],
                     'mkb_sp_2':
                         ['155_Hindi_Bhasha_ke_Vikas_ki_Purvpithika.wav',
                          '151_Hindi_Bhasha_ke_Vikas_ki_Purvpithika.wav']
                     }
