...
def get_transcription_clients(initialization_dict):
    ...
    azure_transcription_client = AzureTranscriptionClient.get_instance(initialization_dict)
    google_transcription_client = GoogleTranscriptionClient.get_instance(initialization_dict)

    return {
        'azure': azure_transcription_client,
