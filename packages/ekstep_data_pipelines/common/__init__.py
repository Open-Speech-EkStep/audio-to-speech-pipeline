...
def get_periperhals(intialization_dict_path, language):
    ...
    config_dict_with_language = get_config_for_given_language(
    ...
    peripheral_dict["audio_commons"] = get_audio_commons(
        config_dict_with_language)
    peripheral_dict["infra_commons"] = get_infra_utils(
        config_dict_with_language)
