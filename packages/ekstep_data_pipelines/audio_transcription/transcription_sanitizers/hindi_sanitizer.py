...
from audio_transcription.transcription_sanitizers.audio_transcription_errors import TranscriptionSanitizationError
...
class HindiSanitizer(BaseTranscriptionSanitizer):
    ...
    def sanitize(self, transcription: str):
        ...
        transcription = transcription.strip()  # removes spaces from the starting and ending of transcription
    ...
    def shouldReject(self, transcription):
        rejected_string = re.sub(pattern=HindiSanitizer.VALID_CHARS, repl='', string=transcription)
