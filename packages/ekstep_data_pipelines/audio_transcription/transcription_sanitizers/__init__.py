...
def get_transcription_sanitizers(**kwargs):
    ...
    from ekstep_data_pipelines.audio_transcription.transcription_sanitizers.kannada_sanitizer import KannadaSanitizer
    ...
    return {'hindi': hindi_sanitizer, 'gujrati': gujrati_sanitizer,'default': hindi_sanitizer,'kannada':kannada_sanitizer}
