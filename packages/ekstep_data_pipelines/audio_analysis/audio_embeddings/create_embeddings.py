...
def create_embeddings(local_audio_download_path, dir_pattern, embed_file_path, fs_interface, npz_bucket_destination_path, source_name):
    ...
    file_map_dict, noise_file_map_dict = create_speaker_clusters(embed_file_path, source_name)
