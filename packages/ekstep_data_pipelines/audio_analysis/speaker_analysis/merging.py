...
class Merge:
    ...
    def get_final_clusters_and_noise(self, big_clusters_indices, all_cluster_embeds, mean_embeds, noise_embeds,
                                     big_cluster_embeds, big_mean_embeds, noise_embeds_big):
        # sanity check and final data prep

        all_cluster_embeds_minus_big = [em_list for i, em_list in enumerate(all_cluster_embeds) if
                                        i not in big_clusters_indices]
