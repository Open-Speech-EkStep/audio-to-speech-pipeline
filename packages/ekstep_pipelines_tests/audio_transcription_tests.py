...
class AudioTranscriptionTests(unittest.TestCase):
    ...
    def test__generate_transcription_and_sanitize_called_with_filename_that_is_not_contained_wav_extension_shoud_not_call_any_function(self):
        ...
        self.audio_transcription.generate_transcription_and_sanitize(1234,'testdir/local_clean_path','testdir/local_rejected_path',file_path,'language',transcription_client,metadata)
