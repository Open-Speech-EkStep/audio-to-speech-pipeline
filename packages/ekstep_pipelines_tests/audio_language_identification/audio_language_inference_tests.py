...
class AudioLanguageIdentificationTests(unittest.TestCase):
    def test_language_inference(self):
        ...
        confidence_score = audio_language_inference.evaluation(
    ...
    def test_language_confidence_score_map(self):
        ...
        language_map_path = (
            "ekstep_pipelines_tests/audio_language_identification/language_map.yml"
        )
        confidence_score = audio_language_inference.language_confidence_score_map(
            confidence_scores, language_map_path)
        print(confidence_score)
        expected_score = {"tamil": "0.00004", "others": "0.99996"}
        self.assertEquals(expected_score, confidence_score)
