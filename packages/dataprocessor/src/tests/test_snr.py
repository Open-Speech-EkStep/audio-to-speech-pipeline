...
#         obj = SNR()
#         self.assertEqual(obj.compute_file_snr('src/tests/test_resources/input/test.wav'), 19.939861)
#
...
#         wav_files = glob.glob(f"{input_dir}*wav")
#         file_snr = obj.fit(wav_files)
#         self.assertEqual(file_snr['src/tests/test_resources/input/test.wav'], 19.939861)
#         self.assertEqual(file_snr['src/tests/test_resources/input/test.wav'], 19.939861)
