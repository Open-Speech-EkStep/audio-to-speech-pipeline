...
class CloudStorageOperations():
    ...
    def download_to_local(self,bucket_name,source_blob_name,destination,is_directory,exclude_extn=None):
        ...
        if(is_directory):
            ...
            for blob in blobs:
                if ((not blob.name.endswith("/")) & (not blob.name[blob.name.rfind("/")+1:len(blob.name)].split(".")[1]==exclude_extn)):
            ...
            print("File {}/{} downloaded to destination directory {} successfully".format(bucket_name,source_blob_name,destination_directory))
    ...
    def upload_to_gcs(self,bucket_name,source,destination_blob_name,is_directory):
        ...
        if(is_directory):
            ...
            print("Running in FILE mode...")
            print("Uploading file from source: {} to destination: {}/{} ".format(source, bucket_name,destination_blob_name))
