GET_EXPERIMENT_ID = (
    "select experiment_id from experiment where experiment_name = :exp_name;"
)
...
INSERT_NEW_ROW_FOR_EXISTING_SOURCE = "insert into source_metadata_processed(source ,num_speaker ,total_duration,cleaned_duration ,num_of_audio,experiment_use_status,experiment_id) values (:source_name,:num_of_speaker,:total_duration,:cleaned_duration,:num_of_audio,True,:exp_id)"

GET_EXISTING_SOURCE = "select * from source_metadata_processed where source = :source"
