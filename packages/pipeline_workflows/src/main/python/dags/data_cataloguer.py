...
# required to debug.
with models.DAG(
        dag_id='data_cataloguer_pipeline',
    ...
    kubernetes_list_bucket_pod = kubernetes_pod_operator.KubernetesPodOperator(
        ...
        # cmds=['echo'],
        cmds=["python", "-m", "src.scripts.data_tagger", "cluster", "ekstepspeechrecognition-dev", "data/audiotospeech/config/datacataloguer/config.yaml"],
        ...
        secrets=[secret_file],
        image='us.gcr.io/ekstepspeechrecognition/data_cataloguer:1.0.0',
