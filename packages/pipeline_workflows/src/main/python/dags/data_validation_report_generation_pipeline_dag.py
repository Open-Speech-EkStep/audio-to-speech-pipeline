...
for source in range(0, 1):
    ...
    globals()[dag_id + 'pre-transcription'] = create_dag(dag_id, 'pre-transcription', default_args=dag_args)
    globals()[dag_id + 'post-transcription'] = create_dag(dag_id, 'post-transcription', default_args=dag_args)
