...
def get_variables():
    ...
    global destination_utterances_path
    global bucket_name
    ...
    destination_utterances_path = Variable.get("destinationutterancespath")
...
def move_utterance_chunk(bucket_name, source_file_name, local_file_name):
    get_variables()
    archive_utterances_file_name = archive_utterances_path + source_file_name.split('/')[-1]
    ...
    try:
        ...
        for i, row in df.iterrows():
            ...
            for extn in extn_list:
                source_blob_name = integration_processed_path + source + "/" + str(
            ...
            move_utterance_chunk(bucket_name, src_file_name, local_file_name)
